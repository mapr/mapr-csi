...
If the kubernetes environment has a different kubelet path, modify the [deployment yaml](../deploy/kubernetes/csi-maprkdf-v1.0.0.yaml) with new path and redeploy the MapR CSI Storage Plugin.
